...
echo "Username,Password & User should not be empty";
}
else
{
          ...
          if (isset($_SESSION['pageStore'])) {
            ...
            switch ($user) {
            	...
            	case 'TCB':
            		$pageStore = "TCB.php";
            		break;
            	case 'Agriculture Ministry':
            		$pageStore = "minAgri.php";
            		break;
            	case 'Ministry of Commerce':
            		$pageStore = "minCom.php";
                break;
              case 'NBR':
                $pageStore = "nbr.php";
                break;
 ...
 <div class="rlform">
  <div class="rlform rlform-wrapper">
   ...
   <form method="post">
    ...
    <div class="rlform-group password-group">
     <label>User</label>
     <select class="rlform-input" name="user">
       <option>--SELECT--</option>>
 	   <option value="BUREAU">BUREAU</option>
      <option value="DAE">DAE</option>
      <option value="NBR">NBR</option>
 	   <option value="CC">CC</option>
 	   <option value="CCI&E">CCI&E</option>
 	   <option value="TCB">TCB</option>
 	   <option value="Agriculture Ministry">Agriculture Ministry</option>
